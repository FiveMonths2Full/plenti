...
const items: CatalogEntry[] = [
  ...
  { name: 'Bay leaves', detail: 'Any brand', size: '0.18 oz', category: 'Cooking Staples' },
  ...
  { name: 'Pancake mix', detail: 'Just-add-water type', size: '32 oz', category: 'Cooking Staples' },
  ...
  { name: 'Pancake syrup', detail: 'Any brand', size: '24 oz', category: 'Cooking Staples' },
  ...
  { name: 'Pancake syrup (small)', detail: 'Any brand', size: '12 oz', category: 'Cereal & Breakfast' },
